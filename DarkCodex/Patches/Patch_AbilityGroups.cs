...
namespace DarkCodex
{
    ...
    public class Patch_AbilityGroups
    {
        ...
        public class MechanicActionBarSlotGroup : MechanicActionBarSlot
        {
            ...
            public override Sprite GetIcon() => Groups.ElementAtOrDefault(this.Index)?.GetIcon() ?? Slots.FirstOrDefault()?.GetIcon(); // TODO: display first active icon
