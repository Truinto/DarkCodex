...
| ------ | ----------- | ------ | ------ |
|General.createAbilityFocus|basic feat: Ability Focus, increase DC of one ability by +2|:book:|:heavy_check_mark:|
|General.patchHideBuffs|unclogs UI by hidding a few buffs|:book:|:heavy_check_mark:|
...
|General.patchDispelMagic|fix Destructive Dispel, apply bonus|:house:|:heavy_check_mark:|
...
|Witch.createCackleActivatable|Cackle/Chant can be toggled to use move action passively|:book:|:heavy_check_mark:|
